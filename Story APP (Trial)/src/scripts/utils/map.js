...
export default class Map {
  ...
  constructor(selector, options = {}) {
    ...
    const mapTilerTile = tileLayer(`https://api.maptiler.com/maps/basic-v2/{z}/{x}/{y}.png?key=${CONFIG.MAP_SERVICE_API_KEY}`, {
      attribution: '&copy; <a href="https://www.maptiler.com/copyright/" target="_blank">MapTiler</a>',
    });

    const mapTilerVector = tileLayer(`https://api.maptiler.com/maps/streets-v2/{z}/{x}/{y}.png?key=${CONFIG.MAP_SERVICE_API_KEY}`, {
      attribution: '&copy; <a href="https://www.maptiler.com/copyright/" target="_blank">MapTiler</a>',
    });
    ...
    const baseLayers = {
      ...
      'MapTiler': mapTilerTile,
      'MapTiler Vector': mapTilerVector,
    };
